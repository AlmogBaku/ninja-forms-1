...
class NF_Whip
{
    ...
    public function whip_message()
    {
        ...
        $message[] = '<strong>' . esc_html__( 'Your site could be faster and more secure with a newer PHP version.', 'ninja-forms' ) . '</strong><br /><br />';
        $message[] = esc_html__( 'Hosts have the ability to update your PHP version, but sometimes they don\'t dare to do that because they\'re afraid they\'ll break your site.', 'ninja-forms' ) . '<br /><br />';
        $message[] = '<strong>' . esc_html__( 'Which version should I update?', 'ninja-forms' ) . '</strong><br /><br />';
        $message[] = sprintf( esc_html__( 'You should update your PHP version to either 5.6 or to 7.3 or 7.4. On a normal WordPress site, switching to PHP 5.6 should never cause issues. We would, however, actually recommend you switch to PHP7. There are some plugins that are not ready for PHP7 though, so do some testing first. Yoast have an article on how to test whether that\'s an option for you %1$shere%2$s. PHP7 is much faster than PHP 5.6. It\'s also the only PHP version still in active development and therefore the better option for your site in the long run.', 'ninja-forms' ) . '<br /><br />',
